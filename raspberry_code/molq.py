...
class DisplayApp:
    ...
    def add_item(self, item):
        ...
        plus_button = tk.Button(item_frame, text="+", command=lambda: self.increase_item(item), font=("Helvetica", 12), bg="#008000", fg="white", relief="flat", width=2)
        ...
        # Store the quantity and price labels for later updates
    ...
    def checkout(self):
        ...
        # Clear the items_frame after checkout
        self.remove_item()

    def increase_item(self, item):
